# Purpose of component: Feature enginnering / Data cleaning / Encoding
import os
import sys
...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer # Useful for encoding
from sklearn.impute import SimpleImputer
from sklearn.pipeline import Pipeline
from sklearn.preprocessing import OneHotEncoder, StandardScaler
# standard scalar is used to standardize the variables in a range
# Onehot encoder is used to encode the categorical features with a binary representation
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Completed reading the training and test data")
